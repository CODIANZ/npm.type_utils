import { IsSame, static_assert, TupleBack, TupleFlatten, TupleFront, TuplePopBack, TuplePopFront, TuplePushBack, TuplePushFront } from "../src";
...
static_assert<IsSame<TupleFlatten<[[[[1]]], [2, [3]], 4]>, [1, 2, 3, 4]>>(true);
